                        ...
                        <table class="table table-data2">
                            ...
                            @if(count($teams)>0)
                                ...
                                <tr class="tr-shadow">
                                    ...
                                    <td> {{$team ->name}}</td>
                                    <td>
                                        <a href="{{route('admin.team.edit', $team ->id)}}" class="btn btn-primary" data-toggle="tooltip" title="Edit">Edit 
                                        </a>
                                        {{-- <button type="button" title="Delete" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">
                                        Delete
                                        </button>   --}}
                                            <form class="d-inline-block" onsubmit="return confirm('Bạn có chắc chắn muốn xóa')" action="{{route('admin.team.delete', $team ->id)}}" method="GET">

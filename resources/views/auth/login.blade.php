                        ...
                        <form action="{{ route('admin.postLogin') }}" method="post">
                            ...
                            <div class="social-login-content">
                                <div class="social-button">
                                    <button class="au-btn au-btn--block au-btn--blue m-b-20">Đăng nhập với Google</button>
                                    <button class="au-btn au-btn--block au-btn--blue2">Đăng nhập với FaceBook</button>
                                </div>
                            </div>
                        </form>
